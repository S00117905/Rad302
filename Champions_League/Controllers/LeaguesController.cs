...
namespace Champions_League.Controllers
{
    public class LeaguesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "LeagueID,Title,Members")] League league)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "LeagueID,Title,Members")] League league)
        {
            if (ModelState.IsValid)
            {
